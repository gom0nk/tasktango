...
export default function VaulDrawer() {
    return (
        <Drawer.Root repositionInputs={false} direction='right'>
            <Drawer.Trigger className="relative w-full flex h-10 flex-shrink-0 items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-4 text-sm font-medium shadow-sm transition-all hover:bg-[#FAFAFA] dark:bg-[#161615] dark:hover:bg-[#1A1A19] dark:text-white">
